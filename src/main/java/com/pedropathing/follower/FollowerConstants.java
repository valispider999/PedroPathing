...
public class FollowerConstants {
     ...
     * @default Localizers.THREE_WHEEL */
     ...
     * @default DcMotorSimple.Direction.REVERSE */
     ...
     * @default DcMotorSimple.Direction.FORWARD */
     ...
     * @default new Vector(convertToPolar[0], convertToPolar[1])
     ...
     * @default new CustomPIDFCoefficients(0.1,0,0,0); */
     ...
     * @default new CustomPIDFCoefficients(0,0,0,0); */
     ...
     * @default new CustomPIDFCoefficients(1,0,0,0); */
     ...
     * @default new CustomFilteredPIDFCoefficients(0.025,0,0.00001,0.6,0); */
     ...
     * @default new KalmanFilterParameters(6,1); */
     ...
     * @see #useSecondaryTranslationalPID
     * @default new CustomPIDFCoefficients(0.3, 0, 0.01, 0) */
     ...
     * @see #useSecondaryHeadingPID
     * @default new CustomPIDFCoefficients(5, 0, 0.08, 0) */
     ...
     * @see #useSecondaryDrivePID
     * @default new CustomFilteredPIDFCoefficients(0.02, 0, 0.000005, 0.6, 0) */
